...
## [2.0.10](https://github.com/ValentinDenis/ZLImageEditor/releases/tag/2.0.10) (2026-04-20)
### Fix:
* Set `defaultLocalization: "en"` in `Package.swift`. SPM requires this when the package ships localized resources (the `.lproj` folders in `ZLImageEditor.bundle`), otherwise resolution fails with "manifest property 'defaultLocalization' not set".

-----

## [2.0.9](https://github.com/ValentinDenis/ZLImageEditor/releases/tag/2.0.9) (2026-04-20)
### Fix:
...
## [2.0.8](https://github.com/ValentinDenis/ZLImageEditor/releases/tag/2.0.8) (2026-04-20)
### Add:
...
## [2.0.7](https://github.com/ValentinDenis/ZLImageEditor/releases/tag/2.0.7) (2026-03-11)
### Add:
